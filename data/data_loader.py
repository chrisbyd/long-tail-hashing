...
def load_data(dataset, root, batch_size, num_workers):
    ...
    """
    if dataset == 'cifar-10':
        train_dataloader, train_contrast_dataloader,query_dataloader, retrieval_dataloader = cifar10.load_data(root,
                                                                                     batch_size,
                                                                                     num_workers,
                                                                                     )
    ...
    return train_dataloader,train_contrast_dataloader ,query_dataloader, retrieval_dataloader
